...
from tgbot.handlers.admin.handlers import get_meetups
...
def setup_dispatcher(dp):
    ...
    dp.add_handler(CommandHandler("get_meetup", admin_handlers.get_meetups))
    dp.add_handler(CommandHandler("invite_to_meetup", admin_handlers.invite_to_meetup))
    ...
    # handling meetups
    dp.add_handler(MessageHandler(Filters.text, admin_handlers.get_meetups))
